<template lang="">
    <div class="main-container">
        ...
        <div class="right-main">
            ...
            <inertia-link class="left-bar-button" style="width: 300px;" href="/register" method="get" as="button" type="button">Regístrate</inertia-link>            
            <inertia-link class="left-bar-button" style="width: 300px;" href="/login" method="get" as="button" type="button">Iniciar sesión</inertia-link>
        </div>
    </div>    
</template>
<script>
