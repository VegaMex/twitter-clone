    ...
    <div class="form">
        <div>
            ...
            <form @submit.prevent="submit">
                ...
                <input class="form-input" id="name" v-model="form.name" />
                <div v-if="errors.name">{{ errors.name }}</div>
                <label for="username">Usuario:</label>
                <input class="form-input" id="username" v-model="form.username" />
                <div v-if="errors.username">{{ errors.username }}</div>
                <label for="email">Correo:</label>
                <input class="form-input" id="email" v-model="form.email" />
                <div v-if="errors.email">{{ errors.password }}</div>
                <label for="password">Contraseña:</label>
                <input class="form-input" id="password" type="password" v-model="form.password" />
                <div v-if="errors.password">{{ errors.password }}</div>
                <button class="left-bar-button" style="width: 300px;" type="submit">Registrar</button>
